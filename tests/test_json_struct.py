...
class T(unittest.TestCase):
    ...
    def test_complex_struct(self):
        ...
        class Video(struct.JsonStruct):
            ...
            highlight_list = struct.ListField(element_field=struct.ListField(element_field=struct.IntegerField(min_value=0)))
        ...
        video.tag_list = ['a-tag', 'b-tag', 'c-tag', ]
        video.rate = 1.0
        video.score = 5
        video.comment_list = [
            {
